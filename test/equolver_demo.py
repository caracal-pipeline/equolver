...
incubi =  ['demo_incubus1', 'demo_incubus2']
incubif = [i+'.fits' for i in incubi]

# Create cubes
beach.Beach(verb = False).gentestcubes(outcubi_prefix = incubi, ctype3 = 'FREQ', channelwidth = 20000, amp0 = 1., ainc = 0.0, pinc = 5., bmaj0 = 10., bmin0 = 7., binc = 1., bpa0 = 0, cinc = 7)
...
beach.Beach(inc_cubes = incubif, tra_fitsnames = outcubif, tra_overwrite = True)
print('Created output cubes {:s} and {:s}'.format(outcubif[0], outcubif[1]))
print()
